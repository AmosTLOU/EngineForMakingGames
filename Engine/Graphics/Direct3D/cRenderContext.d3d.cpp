...
ID3D11DeviceContext* eae6320::Graphics::RenderContext::direct3dImmediateContext = nullptr;
ID3D11RenderTargetView* eae6320::Graphics::RenderContext::s_renderTargetView = nullptr;
ID3D11DepthStencilView* eae6320::Graphics::RenderContext::s_depthStencilView = nullptr;

eae6320::cResult eae6320::Graphics::RenderContext::InitializeViews(const sInitializationParameters& i_initializationParameters)
{
...
void eae6320::Graphics::RenderContext::ClearBackgroundColor(std::vector<float> bgClr)
{
	direct3dImmediateContext = sContext::g_context.direct3dImmediateContext;
	EAE6320_ASSERT(direct3dImmediateContext);
	...
	// by "clearing" the image buffer (filling it with a solid color)
	{
		...
		// clear the bg color
		EAE6320_ASSERT(bgClr.size() == 4);
		const float clearColor[4] = { bgClr[0], bgClr[1], bgClr[2], bgClr[3] };
...
void eae6320::Graphics::RenderContext::SwapBuffer()
{
...
void eae6320::Graphics::RenderContext::CleanUpViews()
{
